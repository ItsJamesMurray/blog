<template>
  <div class="flex-col mx-auto mt-2" :class="darkMode ? 'text-gray-200':''">
    <div
      class="flex items-center sm:m-2 sm:py-2 sm:px-8 rounded cursor-pointer justify-between h-12 "
      ...
      <div class="flex w-10/12 h-16">
        ...
        <div class="flex sm:w-3/12 m-auto justify-end truncate">
          <div v-for="(indicator, idx) in post.fields.Indicator"
            :key=idx
            class="rounded mx-2 p-2 text-xs sm:text-sm font-bold shadow-lg text-left truncate"
